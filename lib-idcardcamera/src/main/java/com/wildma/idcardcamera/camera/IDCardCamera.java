...
public class IDCardCamera {
    ...
    public final static int    TYPE_IDCARD_FRONT     = 1;//aadhaar正面
    public final static int    TYPE_IDCARD_BACK      = 2;//aadhaar反面
    public final static int    TYPE_PAN_FRONT      = 3;//PAN反面
    ...
    public final static String ID_CARD_FRONT_IMG = Base64.encode("idCardFrontCrop.jpg".getBytes());
    public final static String ID_CARD_BACK_IMG  = Base64.encode("idCardBackCrop.jpg".getBytes());
    public final static String PAN_CARD_FORNT_IMG = Base64.encode("panCardFrontCrop.jpg".getBytes());
