...
//                attributes.flags |= flagTranslucentStatus;
     ...
     * @return 动态添加返回键View
     */
//    public static View addBackView(final Activity activity, ViewGroup viewGroup) {
//        //这个就是添加的View
//        Button backBtn = new Button(activity);
//        int size = (int) activity.getResources().getDimension(R.dimen.x50);
//        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(size, size);
//        lp.setMargins((int) activity.getResources().getDimension(R.dimen.x15), getStatusBarHeight(activity) + (int) activity.getResources().getDimension(R.dimen.x25), 0, 0);
//        backBtn.setBackgroundResource(R.drawable.app_bar_back);
//        viewGroup.addView(backBtn, 0, lp);
