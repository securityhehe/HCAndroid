...
//     * @param color
//     */
//    public static void changeTextIntervalColor(TextView textView, String textContent, int textSize, int start, int end, int color) {
//        try {
//            if (TextUtil.isEmpty(textContent)) {
//                return;
//            }
//            Spannable span = new SpannableString(textContent);
//            if (textSize > 0)
//                span.setSpan(new AbsoluteSizeSpan(ScreenAdapter.adapterWidthSize(ContextHolder.getContext(), textSize)), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
...
//     * @param color
//     */
//    public static void changeBigText(TextView textView, String textContent, int length, int[] textSize, int[] start, int[] end, int[] color) {
//        try {
//            Spannable span = new SpannableString(textContent);
//            for (int i = 0; i < length; i++) {
//                span.setSpan(new AbsoluteSizeSpan(ViewSizeAdapterUtils.calcAdapterSize(ContextHolder.getContext(), textSize[i])), start[i], end[i], Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//                span.setSpan(new ForegroundColorSpan(ContextCompat.getColor(ContextHolder.getContext(), color[i])), start[i], end[i], Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//            }
//            textView.setText(span);
//        } catch (Exception e) {
//            textView.setText(textContent);
